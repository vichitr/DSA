...
void addEdge(struct Graph* graph, int src, int dest, int weight, int dir)
{
...
void PrimMST(struct Graph* graph)
{
    ...
    int v, key[V];      // Key values used to pick minimum weight edge in cut
...
int main()
{
    ...
    do
    {
        printf("1. Add edge 2. Print 3. Prims MST 4.Exit : ");
        scanf("%d", &c);
        switch(c)
        {
            case 1:
